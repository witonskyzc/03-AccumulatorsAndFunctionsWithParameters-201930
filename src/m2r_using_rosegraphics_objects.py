...
#            window.render() draws all shapes in window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            RoseWindow close_on_mouse_click is almost always necessary because without it the window closes right away.
#
